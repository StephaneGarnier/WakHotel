/*! angular-wakanda - v1.0.3 - 2016-01-14 */
(function(exports, global) {
    ...
    WAF.core.restConnect.restRequest = function(connectionMode) {
        ...
        this.go = function(options) {
            ...
            if (this.postAFile) {
                if (this.postAPict) queryString += !deja$ ? "$rawPict=true" : "&$rawPict=true"; else queryString += !deja$ ? "$binary=true" : "&$binary=true";
                deja$ = true;
            }
    ...
    WAF.DataClass.getEntityByURIOrKey = function(key, dataURI, options, userData) {
        ...
        var request = new WAF.core.restConnect.restRequest(true);
        if (null != dataURI) request.fullURL = dataURI; else {
            request.resource = dataClass.getNameForRest();
            if (null != options.queryAttribute) request.resource += ":" + options.queryAttribute.name;
    ...
    WAF.DataClass.getEntity = function(key, options, userData) {
        ...
        options = resOp.options;
        var dataClass = this;
        if (null != options.relatedDestAtt) dataClass._private.getEntityByURIOrKey(key, null, options, userData); else if (dataClass.mustCacheRef()) {
    ...
    WAF.EntityAttributeSimple.resolveFile = function(options, userData) {
        ...
        if (null != this.unResolvedFile) {
            ...
            request.postAPict = "image" === this.att.type;
            request.handler = function() {
                if (4 != request.http_request.readyState) return;
                var error = false;
                var err = null;
    ...
    WAF.EntityAttributeRelated.setValue = function(relatedEntity) {
        ...
        this.owner.touch();
        this.dataURI = null;
        if (null == relatedEntity) this.relKey = null; else {
            this.relKeyIsForcedPrimkey = true;
            if (relatedEntity instanceof WAF.Entity) this.relKey = relatedEntity.getKey(); else if (this.relKey !== relatedEntity) {
                this.relEntity = null;
